...
begin ;
insert into users (first_name, last_name) values ('New', 'User') returning id;
insert into products (name, department, price, weight) values ('New Product', 'Electronics', 99.99, 5) returning id;
commit;

begin;
savepoint start_point;
insert into users (first_name, last_name) values ('John', 'Snow') returning id;
insert into orders (user_id, product_id, order_date, shipment_date, paid)
values (1, 1, '2023-12-01', '2023-12-05', false);
commit;

begin;
savepoint start_point;
update products set price = 109.99 where id = 1;
select count(*) from users;
commit ;

begin;
savepoint start_point;
update products set price = 129.99 where id = 15;
update orders set paid = true where product_id = 17;
commit;

begin;
savepoint start_point;
update products set weight = 10 where id = 29;
select weight from products where id = 29;
commit;

begin transaction isolation level serializable;
insert into users (first_name, last_name) values ('Sansa', 'Stark');
insert into products (name, department, price, weight) VALUES ('Blender', 'Electronics', 99.99, 5);
commit;